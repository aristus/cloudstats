...
delete from cloudstats.cloudstats_bill
where
--  date_month >= date_format(date_add('day', -65, to_timestamp('{{ get_batch_id(ts) }}'), '%Y-%m')
  date_month >= date_format(date_add('day', -65, current_date), '%Y-%m');
